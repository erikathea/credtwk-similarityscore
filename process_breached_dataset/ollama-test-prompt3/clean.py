...
clean_csv_file("output-test-prompt3-8b.csv", "output-cleaned-prompt3-8b.csv", "output-noise-prompt3-8b.csv")
clean_csv_file("output-test-prompt3-14b.csv", "output-cleaned-prompt3-14b.csv", "output-noise-prompt3-14b.csv")
