...
compute_averages("output-cleaned-prompt3-8b.csv", "output-computed-prompt3-8b.csv")
compute_averages("output-cleaned-prompt3-14b.csv", "output-computed-prompt3-14b.csv")
