...
ax.text(-0.85, 0.48, "0.5 Threshold", color="black", fontsize=12, va="bottom")
...
# Axis formatting
ax.set_title("HSS Scores for Password Variants Generated using Prompt 2", fontsize=16, pad=25)
...
plt.tight_layout()
plt.savefig("hss_violin_prompt2.png", dpi=600, bbox_inches="tight")
plt.show()
